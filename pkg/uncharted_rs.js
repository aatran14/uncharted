/* @ts-self-types="./uncharted_rs.d.ts" */
...
export class Game {
     ...
     */
    ai_move() {
        const ret = wasm.game_ai_move(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {number} index
     ...
     */
    human_move(index) {
        const ret = wasm.game_human_move(this.__wbg_ptr, index);
        return ret;
    }
    /**
     * @returns {boolean}
     */
    is_active() {
        const ret = wasm.game_is_active(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @returns {number}
     */
    last_ai_cell() {
        const ret = wasm.game_last_ai_cell(this.__wbg_ptr);
        return ret;
    }
    constructor() {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('uncharted_rs_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
